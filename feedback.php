...
<title>Online Examinaton || FEEDBACK </title>
...
<div class="col-md-10">
<a href="mailto:pedregosamarvin29@gmail.com" style="color:#000000">pedregosamarvin29@gmail.com</a><br /><br />
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image/mars.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="https://www.facebook.com/bullyvin/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Marvin A. Pedregosa</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+639569900811</h4>
    <h4 style="font-family:'typo' ">pedregosamarvin29@gmail.com</h4>
    <h4 style="font-family:'typo' ">St. John Technological College of the Philippines</h4></div></div>
		</p>
      </div>
